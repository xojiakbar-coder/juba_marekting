                ...
                <div>
                    <div className="container container2 mx-auto pb-20">
                        <Navbar servise_list={serviseData} contact={contact} />
                        {
                            sliderData?.map((i, index) => (
                                <ImageOverlay key={index} title={i?.title} short_description={i?.short_description} photo={i?.photo} />
                            ))
                        }
                    ...
                    <div className='w-full bg-white py-20 justify-center'>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 mt-20 items-center gap-20">
                            ...
                            <div className='text-gray2 justify-self-center  lg:justify-self-start text-center sm:text-start'>
                                <h1 className='leading-7 font-normal text-xl'><a href={`tel:${contact?.phone_number}`}>{contact?.phone_number?.length === 13 ? `${contact?.phone_number.slice(0, 4)} ${contact?.phone_number.slice(4, 6)} ${contact?.phone_number.slice(6, 9)} ${contact?.phone_number.slice(9, 11)} ${contact?.phone_number.slice(11, 13)}` : contact?.phone_number}</a><br />
                    ...
                    <div className='py-20'>
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-y-5 justify-items-center text-gray3">
                            <input className="w-full border border-black4 max-w-xs bg-gray2 px-4 py-2 rounded-xl" value={name} onChange={(e) => setName(e.target.value)} placeholder="Имя" type="text" required maxLength={16} />
                            <input className="w-full border border-black4 max-w-xs bg-gray2 px-4 py-2 rounded-xl" value={tel} onChange={(e) => setTel(e.target.value)} placeholder="Телефон номер" type="tel" required maxLength={13} />
                        </div>
